          ...
          <>
            <div id="section5_animation">
              <div className="animation-img">
                <img src="/animation_img11.png" alt="" />
              </div>
              <div className="animation-img">
                <img src="/animation_img12.png" alt="animation" />
              </div>
              <div className="animation-img">
                <img src="/animation_img13.jpg" alt="animation" />
              </div>
              <div className="animation-img">
                <img src="/animation_img14.png" alt="animation" />
              </div>
              <div className="animation-img">
                <img src="/animation_img15.jpg" alt="animation" />
              </div>
              <div className="animation-img">
