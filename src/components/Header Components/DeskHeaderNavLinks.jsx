  ...
  return (
    <div className="flex items-center justify-center gap-8 text-[0.9rem] font-[400]">
         <ul className="flex justify-center items-center gap-10 text-[#6f6f6f]">
          <li id={activeTab === 'navitem0' ? "active-navItem" : "navitem0"} onMouseEnter={() => setActiveTab('navitem0')} onMouseLeave={() => setActiveTab('')}><Link to="/process">The Hashtag Web Way</Link></li>
          ...
          <li id={activeTab === 'navitem2' ? "active-navItem" : "navitem2"}><Link to="/engagement-model" onMouseEnter={() => setActiveTab('navitem2')} onMouseLeave={() => setActiveTab('')}>How We Engage</Link></li>
